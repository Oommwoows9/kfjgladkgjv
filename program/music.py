...
@Client.on_message(command(["محمد شغل","/play","تشغيل","/mplay", f"/mplay@{BOT_USERNAME}"]) & other_filters)
...
@Client.on_message(command(["رابط","/stream", f"/stream@{BOT_USERNAME}"]) & other_filters)
